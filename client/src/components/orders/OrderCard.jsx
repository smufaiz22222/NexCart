...
function OrderBankPaymentInfo({ order, isWholesalerPath, isUpiPayment, cleanReferenceNo }) {
...
function OrderDisputesSection({ order, user, isWholesalerPath, showIssueForm, setShowIssueForm }) {
  return (
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4">
          <div>
            ...
            <p
              className={cn('text-xs mt-1', isWholesalerPath ? 'text-zinc-400' : 'text-[#6C757D]')}
            >
              {user?.role === 'WHOLESALER'
    ...
    >
      ...
      <div className="flex flex-wrap gap-3 w-full md:w-auto">
        ...
        {user?.role === 'CUSTOMER' && !canCustomerOpenIssue(order.status) && (
          ...
          >
            <Undo2
              className={cn('h-3.5 w-3.5', isWholesalerPath ? 'text-amber-400' : 'text-[#0047AB]')}
            />
...
export default function OrderCard({ order, user, isWholesalerPath }) {
  ...
  return (
    ...
    >
      ...
      <OrderBankPaymentInfo
        order={order}
        isWholesalerPath={isWholesalerPath}
        isUpiPayment={isUpiPayment}
        cleanReferenceNo={cleanReferenceNo}
      />
      ...
      <OrderCardFooter
        ...
        handleVerifyBankPayment={handleVerifyBankPayment}
