export default function StatCard({ title, value, icon: Icon, tone, desc }) {
  return (
    <div className="rounded-[22px] border border-zinc-800 bg-[#111111] p-5 shadow-[0_14px_40px_rgba(0,0,0,0.24)] transition hover:shadow-[0_18px_50px_rgba(0,0,0,0.30)]">
