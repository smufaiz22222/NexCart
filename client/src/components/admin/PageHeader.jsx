...
export default function PageHeader({ icon: Icon, badge, title, description, className }) {
  return (
    <section className={cn('rounded-xl border border-[#2B3139] bg-[#12161C] px-6 py-6', className)}>
      {badge && (
      ...
      <h1 className="mt-3 max-w-3xl text-2xl font-bold text-[#EAECEF] sm:text-3xl">{title}</h1>
      {description && (
