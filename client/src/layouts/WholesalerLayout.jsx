...
export default function WholesalerLayout() {
  ...
  return (
    <div
      className={`wholesaler-theme ${theme === 'light' ? 'theme-light bg-[#f0fdf9]' : 'theme-dark bg-[#0B0F19]'} h-screen overflow-hidden flex font-sans selection:bg-[#059669]/30 selection:text-[#0F172A] transition-colors duration-300`}
    >
      {/* Sidebar Layout */}
      <aside
      ...
      <div
        className={`flex-1 flex flex-col min-w-0 h-full overflow-hidden transition-colors duration-300 ${theme === 'light' ? 'bg-[#f0fdf9]' : 'bg-[#0B0F19]'}`}
      >
        {/* Header Bar */}
        <header
        ...
        <main
          className={`flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto transition-colors duration-300 ${
