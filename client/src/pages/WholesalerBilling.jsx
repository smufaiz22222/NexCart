              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-zinc-400">
                    Select duration first, then pay through Razorpay or open the support payment
                    card for Standard and Premium.
                  </p>
                </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-[28px] border border-zinc-800 bg-[#171717] p-6 shadow-[0_18px_50px_rgba(0,0,0,0.24)]">
              ...
              <div className="mt-5 space-y-3">
                <InfoRow
                  label="Plan"
                  value={summary?.subscription?.plan?.name || 'Not activated'}
                />
                <InfoRow
                  label="Duration"
                  value={
            ...
            >
              ...
              <p className="mt-4 text-xs text-zinc-500 leading-5">
                Click &quot;Pay via Support&quot; on any plan to scroll here. After payment
                confirmation, your subscription is activated from the admin dashboard.
              </p>
            </div>
