...
import AdminPayoutActionModal from '../components/admin/AdminPayoutActionModal';
...
function PayoutsOverview({ pendingRequestsCount, pendingAmountSum }) {
  return (
...
function PayoutsTable({ filteredRequests, activeTab, setSelectedPayout, setModalType }) {
  return (
