        ...
        <main className="flex-1">
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-24 bg-[#1c1c1c] rounded-lg border border-dashed border-zinc-700">
              ...
              <p className="text-sm text-zinc-400">Try adjusting your search or category filters.</p>
              <button 
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center gap-1.5 mb-3">
                      ...
                      <p className="text-xs text-zinc-400 truncate">
                        Sold by <span className="font-medium text-zinc-200">{product.wholesaler?.businessName || 'Unknown Shop'}</span>
                      </p>
                    </div>
