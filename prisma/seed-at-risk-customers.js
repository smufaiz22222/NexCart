...
const firstNames = [
  ...
  'Shaurya', 'Atharv', 'Advait', 'Dhruv', 'Kabir', 'Ritvik', 'Aarush', 'Rudra', 'Pranav', 'Harsh',
  'Ananya', 'Diya', 'Myra', 'Sara', 'Aadhya', 'Isha', 'Kiara', 'Zara', 'Anika', 'Riya',
  'Prisha', 'Navya', 'Tara', 'Mira', 'Aanya', 'Pari', 'Ahana', 'Saanvi', 'Kavya', 'Ishita',
  'Rohan', 'Kunal', 'Mohit', 'Vikram', 'Tanvi', 'Pooja', 'Neha', 'Rahul', 'Amit', 'Sneha',
];

const lastNames = [
  'Sharma', 'Verma', 'Gupta', 'Singh', 'Patel', 'Kumar', 'Jain', 'Mehta', 'Agarwal', 'Mishra',
  'Reddy', 'Nair', 'Menon', 'Iyer', 'Rao', 'Kapoor', 'Bhat', 'Desai', 'Shah', 'Thakur',
];
